...
// describe("2.2.1 TypedPromise", function () {
//   describe("2.2.1.1 optional onFulfilled and onReject", function () {
//     it("TypedPromise.then should ignore none function onFulfilled, onReject", function (done) {
//       done();
//       const VALUE = "ok";
...
//         done();
//       }, function (error) {
//         assert(error instanceof TypedPromise);
//         done();
//       });
//     });
//   });
